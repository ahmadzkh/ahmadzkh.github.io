                        ...
                        <div class="row">
                            @if ($count_bill_check=='0')
                                <div class="container justify-content-center align-items-center text-center">
                                    <p><i class="fas fa-sad-tear"></i> {{$count_bill_check}} Transaction | 404 NOT FOUND</p>
                                </div>
                            @endif
                            @if ($count_bill_check!='0')
                            ...
                            <div class="col-sm">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <a href="/trans/{{$check->id}}/refuse" class="btn btn-outline-danger mt-sm-3 w-100"><i class="fas fa-check-circle" ></i> Refuse</a>
                                            </div>
                                            <div class="col-sm">
