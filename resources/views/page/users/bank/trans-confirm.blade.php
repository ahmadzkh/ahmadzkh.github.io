    ...
    <div class="container">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <form action="/trans/{{$bill->id}}/confirmnow" method="POST" class="py-sm-3">
                    {{csrf_field()}}
                    ...
                    <input type="text" name="bank" class="form-control" id="bank" value="{{$bill->bank}}" hidden>
                    <input type="text" name="checked" class="form-control" id="checked" value="2" hidden>
                    <button type="submit" class="btn btn-primary float-right" onclick="return confirm('Are you sure you want to confirm this transaction ?')"><i class="fas fa-check-circle" ></i> Confirmation</button>
