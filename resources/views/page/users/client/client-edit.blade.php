...
<section class="page-section">
    <div class="container">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="/client/{{$data_pelanggan->id}}/update" method="POST">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label for="exampleFormControlInput1">First Name</label>
                            <input type="text" name="nama_depan" class="form-control" id="exampleFormControlInput1" value="{{$data_pelanggan->nama_depan}}" autofocus>
                        </div>
                        <div class="form-group col-sm-6">
                            <label for="exampleFormControlInput2">Last Name</label>
                            <input type="text" name="nama_belakang" class="form-control" id="exampleFormControlInput2" value="{{$data_pelanggan->nama_belakang}}" autofocus>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput5">Phone Number</label>
                        <input type="text" name="no_telp" class="form-control" id="exampleFormControlInput5" value="{{$data_pelanggan->no_telp}}" autofocus>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput6">ID PLN</label>
                        <input type="text" name="no_pln" class="form-control" id="exampleFormControlInput6" value="{{$data_pelanggan->no_pln}}" autofocus>
                    </div>
                    <div class="form-group">
